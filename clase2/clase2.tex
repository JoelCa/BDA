...
Para hacer esta complejidad adicional transparente para el usuario, la funcionalidad conocida como \textit{navegación de agregados}, se utiliza para consultar las tablas dimensionales y de hecho, con el nivel de granularidad correcto.
La navegación global examina esencialmente la consulta para ver si se puede responder mediante una tabla de agregación más pequeño.
}
\end{frame}
