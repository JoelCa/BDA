...
\begin{itemize}
  ...
  \item \textbf{Volatilidad de los datos de origen}: las RDBs tratan mejor la alta volátilidad de los datos. Los datos multidi- mensionales en hipercubos generalmente tardan mucho en cargarse y actualizarse.
