...
% El uso del MTS, permite añadir facilmente una cuarta dimensión al modelo.
% El MTS muestra el número de puntos de datos extraídos del evento y su organización lógica.
% Muestra más información estructural que un cubo, y puede mostrarnos un número arbitrario de dimensiones.
% Si desea una representación útil de los datos en forma numérica, es necesario utilizar algún tipo de visualización en forma de rejilla.
% }
% \end{frame}
