...
\fbckg{negro}
\begin{frame}
\misc{\includegraphics[scale=0.25,center]{componentes}}
\end{frame}
...
\begin{center}
\includegraphics[scale=0.7]{estrella}
\end{center}
...
Este otro tipo de esquemas, es similar al esquema de estrella salvo por cierto detalle, las dimensiones pueden, a su vez, estar conectadas con otras tablas de dimensiones.
