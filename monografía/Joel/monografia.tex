...
\begin{document}
  ...
  % ############################ INICIO RESUMEN ############################
    ...
    Una característica fundamental de los sistemas OLAP es permitir la visión de los datos en distintas perspectivas y niveles de detalle, el cual
    ...
    Son las operaciones OLAP, como \textit{drill-up}, \textit{drill-down}, las que se proveen esta funcionalidad.
  ...
  % ############################ INICIO INTRODUCCIÓN ############################  
    ...
    con alguna entidad externa, o efectuar movimientos internos, como por ejemplo el ingreso de personal, gastos administrativos,
    ...
    A principios de los 90', como consecuencia del auge de la competitividad, las organizaciones requirieron sofisticados análisis de los datos que sustenten
    el proceso de toma de decisiones. Las bases de datos transaccionales u operacionales no satisfacen esta demanda, ya que estas fueron diseñadas y
    optimizadas para soportar operaciones de negocios diarias, cuyo principal objetivo es asegurar el acceso concurrente de múltiples usuarios, proporcionando
    ...
    %Las bases de datos operacionales tienen datos detallados, no históricos.
    ...
    dos dimensiones (en forma de grilla), las operaciones básicas sobre el mismo, y las principales arquitecturas OLAP (ROLAP, MOLAP, HOLAP).
  ...
  % ############################ INICIO CONCEPTOS BÁSICOS ############################
    ...
    \begin{itemize}
      ...
      %Por ejemplo, 2 sectores de la empresa en cuestión informan valores distintos para la venta de un producto en el mismo
      %período de tiempo.
...
%       permiten contrastar la situación actual con una situación retrospectiva de años atrás.
    ...
    \begin{itemize}
      ...
      puede tener una pequeña solución a un costo no tan elevado. Una vez que todos los DM estén en marcha, se puede decidir si construir el DW o no.
