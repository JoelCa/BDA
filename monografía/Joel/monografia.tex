...
\begin{document}
  ...
  % ############################ INICIO INTRODUCCIÓN ############################  
    ...
    etc.).
    %Luego se utiliza toda esta información para analizarla y, así comenzar el proceso de toma de decisiones 
...
%       permiten contrastar la situación actual con una situación retrospectiva de años atrás.
    ...
    Al tener una dimensión representada por varias tablas, se facilita su mantenimiento. % ¿Por que?
    ...
    \begin{itemize}
      ...
      En cualquier caso, se deben tener en cuenta las limitaciones de la herramienta que se utilize.
    \end{itemize}
