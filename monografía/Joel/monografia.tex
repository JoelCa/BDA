...
\begin{document}
  ...
  % ############################ INICIO INTRODUCCIÓN ############################  
    ...
    su uso para la optimización de la respuesta ante una consulta, la interpretación del cubo OLAP en dos dimensiones (en forma de grilla), las operaciones
    básicas sobre el cubo OLAP, y las principales arquitecturas OLAP.
    
    En la sección 4, se detallan cuatros temas en investigación relacionados con el Data Warehouse, los cuales son:
    \begin{itemize}
      \item El modelo \textit{MultiDim}, como diseño conceptual del Data Warehouse.
      \item El modelo de meta tablas \textit{Fuzzy Data Warehouse}, para integrar conceptos difusos en un Data Warehouse.
    \end{itemize}
