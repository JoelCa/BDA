  ...
  %\begin{flushleft}
    ...
    \begin{figure}
      \begin{center}
        ...
        \caption{Cubo con 3 dimensiones, \textit{Variable, Time, Product}. \cite{olap_solutions} Pag. 49.}
        \label{cube_2}
      \end{center}
    \end{figure}
    ...
    \begin{figure}
      \begin{center}
        ...
        \caption{\textbf{Visualización del cubo}, ``rebanada'' del cubo seleccionando un valor específico de la dimensión \textit{Product}.} \cite{olap_solutions} Pag. 51.
        \label{cube_3}
      \end{center}
    \end{figure}
    ...
    \begin{figure}
      \begin{center}
        ...
        \caption{Transformación de dos dimensiones a una. Variables anidadas en Productos. \cite{olap_solutions} Pag. 58.}
        \label{cube_5}
      \end{center}
    \end{figure}
    ...
    \begin{figure}
      \begin{center}
        ...
        \caption{Transformación de dos dimensiones a una. Productos anidados en Variables. \cite{olap_solutions} Pag. 58.}
        \label{cube_6}
      \end{center}
    \end{figure}
