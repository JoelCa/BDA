...
Para ilustrar una variable lingüística, consideramos un conjuntos de películas. Cada película tiene una duración específica.
Podemos definir una variable lingüística \textit{duration}. Podemos dividir \textit{duration} en un conjunto de términos lingüísticos $\{ very\,short, short, medium, long, very\,long \}$. Para cada duración de una película, la perteneciente a un término lingüística puede definirse utilizando una regla semántica.
Dinimos la variable ligüística $duration$, como sigue:
...
El meta modelo de Fuzzy Data Warehouse
\end{center}
...
El uso términos lingüísticos puede proporcionar una interpretación más precisa de las medidas para los usuarios.
En [FZ09], se propone un almacén de datos difuso para un sistema de análisis web. Se demuestra que las medidas en bruto de análisis web no siempre son fáciles de interpretar. No siempre es posible contar las visitas de los distintos usuarios con precisión.
