...
\justifying El uso términos lingüísticos puede proporcionar una interpretación más precisa de las medidas para los usuarios.
En \cite{Fase09}, se propone un Fuzzy Data Warehouse para un sistema de análisis web, donde se demuestra que las medidas para un análisis web no siempre son fáciles de interpretar, pues no es posible contar las visitas de distintos usuarios con precisión.
