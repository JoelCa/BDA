...
\misc
{
\justifying \textbf{Mondrian}, es un servidor de procesamiento analítico relacional en línea (ROLAP), open-source; escrito en java.
Soporta MDX (multidimensional expressions), como lenguaje de consulta, y XML for Analysis (XMLA).

\justifying A continuación mostraremos la herramienta \textbf{Saiku Community}, la cual nos provee de una interfaz gráfica, para analizar
los datos.
